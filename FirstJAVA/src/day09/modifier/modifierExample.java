...
/*
 *		Modifier				Same Class				Same Package				Other package & Sub Class				Other package(전체)
 *
 *		=-----------------------------------------------------------------------------------------------------------------------------------=
 *		public						O						O									O									O
 * 		protected	     			O						O									O									X
 ...
 * 		(클래스의 경우에는 public과 default(공백)만 가능함. 단, 내부 클래스는 4가지 접근 제한자 다 가능)
 * 
 */
...
//							"\num2= "+sup.num2+			// protected
//							"\tnum3= "+ sup.num3+		// default
							"\tnum4= "+sup.getNum4()); 	// public method..직접 참조 가능
