...
public class UserDefineException {
	...
	public static void main(String[] args) {
		...
		try {
			memberManager.insert(new Member("홍길동", "010-1234-5678", "서울시 마포구"));
...
// 멤버 클래스(DATA를 저장하는 용도의 객체를 생성하기 위한 클래스)
class Member {
	String name;
	String phone;
	String address;
