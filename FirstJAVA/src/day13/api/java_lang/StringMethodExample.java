...
public class StringMethodExample {
	...
	public static void main(String[] args) {
		...
		// 2. split: 문자열을 원하는 기준으로 자른다. -> 바열로 반환
		...
		// 3. indexOf: 원하는 문자의 인덱스를 반환(못찾으면 -1)
		int orange_index = str.indexOf("orange");
		System.out.println("오렌지 위치: " + orange_index);
		int orange_index2 = str.indexOf("Orange");
		System.out.println("오렌지 위치: " + orange_index2);
		
		System.out.println("첫 o의 위치: " + str.indexOf("o"));
		...
		if(str.contains("apple")) {
			System.out.println("사과도 과일!");
		} else {
			System.out.println("사과는 과일이 아니라고?");
		}
		...
		// 10. trim: 문자열 바깥 쪽 공백 제거(equals예제도 추가)
		String id_1 = "		abc   123  ";
		String id_2 = " abc   123		";
		...
		System.out.println("trim하고 equals: " + id_1.equals(id_2));
		
		// 11. format: 서식문자열을 이용하여 문자열을 만들어서 반환
		str = String.format("%d: %d: %d", 14,45,94);
		System.out.println(str);
